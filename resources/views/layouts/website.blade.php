                        ...
                        <div class="row">
                            <div class="col">
                                <div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
                                    <div class="top_bar_phone"><span class="top_bar_title">phone:</span>+8801303382924</div>
                                    <div class="top_bar_right ml-auto">
                                        ...
                                        <div class="top_bar_social">
                                            ...
                                            <ul>
                                                <li><a href="https://www.facebook.com/noyon.noyon.505523/" target="_blank"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
        ...
        <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
            ...
            <div class="menu_extra">
                ...
                <div class="menu_social">
                    ...
                    <ul>
                        <li><a href="https://www.facebook.com/noyon.noyon.505523/" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
